      ...
      <div className="flex flex-1 flex-col">
        <div className="flex flex-1 flex-col gap-2 p-4 md:gap-6 md:p-6">
          <div className="mb-4">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Visão geral do desempenho de vendas e inventário.</p>
          </div>
                ...
                {[40, 70, 45, 90, 65, 85, 120, 95].map((height, i) => (
                  <div key={i} className="flex-1 flex flex-col items-center justify-end gap-2 h-full">
                    <div 
                      ...
                      style={{ height: `${height}%` }}
                    />
                    <span className="text-[10px] text-muted-foreground uppercase">{["Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago"][i]}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="col-span-1 flex flex-col gap-6">
              <div className="rounded-xl border border-border bg-surface p-6 flex-1">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-sm text-whatsapp flex items-center gap-1"><TrendingUp size={14}/> +1.2%</span>
                </div>
                <p className="text-xs text-muted-foreground mt-2">Leads do WhatsApp que converteram em vendas.</p>
              </div>
              ...
              <div className="rounded-xl border border-border bg-surface p-6 flex-1">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">O segmento mais procurado.</p>
                  </div>
                </div>
              </div>
            </div>
